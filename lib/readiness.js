...
export function calculateAdjustedLoad(actualRpe, sleepQuality, stress, soreness, mood) {
  ...
  const questionnaireAvg = questionnaireTotal / 4;

  return Number(actualRpe || 0) * questionnaireAvg;
}
